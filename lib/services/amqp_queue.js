...
exports.put = function(req, res, cb, params) {
	...
	var amqpPublish = 'curl -i -u ' + params['user'] + ' -H "content-type:application/json" -XPUT -d \'{"auto_delete":false,"durable":true}\' http://' + params['host'] + ':' + params['port'] + '/api/queues/' + params['vhost'] + '/' + params['queue'];
